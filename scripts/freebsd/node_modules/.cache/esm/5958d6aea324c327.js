let isEmacs;_a32‍.x([["meteorCommandsJsonPath",()=>meteorCommandsJsonPath],["dumpMeteorCommands",()=>dumpMeteorCommands]]);_a32‍.w("../utils/utils.js",[["isEmacs",["isEmacs"],function(v){isEmacs=v}]]);var showRequireProfile = ('METEOR_PROFILE_REQUIRE' in process.env);
...
///////////////////////////////////////////////////////////////////////////////
       ...
       const meteorCommandsJsonPath = files.pathJoin(
...
var springboard = function (rel, options) {
  ...
  if (process.env.METEOR_DEBUG_SPRINGBOARD) {
    _a32‍.g.console.log("WILL SPRINGBOARD TO", rel.getToolsPackageAtVersion());
  }
